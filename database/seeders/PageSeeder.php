        ...
        $translations = [
            [
                ...
                'content' =>
                    ...
                    Html::tag('div', '[featured-projects title="Dự án nổi bật" subtitle="Chúng tôi đưa ra những lựa chọn tốt nhất với những dự án hot nhất và uy tín nhất, vui lòng truy cập chi tiết bên dưới để tìm hiểu thêm."][/featured-projects]') .
                    Html::tag('div', '[properties-by-locations title="Bất động sản theo khu vực" subtitle="Mỗi nơi là một sự lựa chọn tốt sẽ giúp bạn đưa ra quyết định đúng đắn, đừng bỏ lỡ cơ hội khám phá những bất động sản tuyệt vời của chúng tôi."][/properties-by-locations]') .
                    Html::tag('div', '[properties-for-sale title="Bất động sản bán" subtitle="Dưới đây là danh sách các bất động sản hiện đang được bán."][/properties-for-sale]') .
                    Html::tag('div', '[properties-for-rent title="Bất động sản ở cho thuê" subtitle="Dưới đây là danh sách các bất động sản hiện đang được cho thuê."][/properties-for-rent]') .
                    ...
                    Html::tag('div', '[latest-news title="Tin tức" subtitle="Dưới đây là tin tức bất động sản mới nhất được chúng tôi cập nhật thường xuyên từ các nguồn đáng tin cậy."][/latest-news]')
                ,
            ],
            [
                'name' => 'Tin tức',
