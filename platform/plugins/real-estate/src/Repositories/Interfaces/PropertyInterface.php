...
{
    public function getRelatedProperties(int $propertyId, int $limit = 4, array $with = []): Collection|LengthAwarePaginator;

    public function getProperties(array $filters = [], array $params = []): Collection|LengthAwarePaginator;

    public function getProperty(int $propertyId, array $with = []): ?Property;
