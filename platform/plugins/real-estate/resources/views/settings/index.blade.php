        ...
        <div class="flexbox-annotated-section">
            ...
            <div class="flexbox-annotated-section-content">
                <div class="wrapper-content pd-all-20">
                    ...
                    <div class="form-group mb-3">
                        <label class="text-title-field"
                               for="real_estate_hide_properties_in_statuses">{{ trans('plugins/real-estate::settings.hide_properties_in_statuses') }}
                        </label>
                        @foreach(\Botble\RealEstate\Enums\PropertyStatusEnum::labels() as $key => $label)
                            <label class="me-2">
                                <input type="checkbox" name="real_estate_hide_properties_in_statuses[]"
                                       value="{{ $key }}"
                                       @if (in_array($key, RealEstateHelper::exceptedPropertyStatuses())) checked @endif>{{ $label }}
                            </label>
                        @endforeach
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        @foreach(\Botble\RealEstate\Enums\ProjectStatusEnum::labels() as $key => $label)
                            <label class="me-2">
                                <input type="checkbox" name="real_estate_hide_projects_in_statuses[]"
                                       value="{{ $key }}"
                                       @if (in_array($key, RealEstateHelper::exceptedProjectsStatuses())) checked @endif>{{ $label }}
                            </label>
                        @endforeach
                    </div>
                </div>
